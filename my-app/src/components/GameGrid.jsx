                  ...
                  <div className="mt-4 space-y-4">
                    ...
                    <div className="pt-3 flex items-center justify-between gap-3" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        ...
                        className="flex-1 text-center rounded-full px-4 py-3 text-sm font-bold text-white hover:opacity-90 transition-all duration-200"
              ...
              >
                ...
                <div className="relative z-10 space-y-3" onClick={(e) => e.stopPropagation()}>
                  <a
                    ...
                    className="block w-full text-center rounded-full px-4 py-3 bg-yellow-400 text-gray-900 font-bold text-base hover:bg-yellow-300 transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
                    View Details
                  </a>
                  <div onClick={(e) => e.stopPropagation()} className="w-full">
                    <AddToCartButton gameId={p.id} fullWidth />
                  </div>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                    ...
                    className="w-full rounded-full px-4 py-3 bg-white/20 text-white font-bold text-base hover:bg-white/30 transition-all duration-200 border-2 border-white/40"
                  >
                    ← Back
                  </button>
                </div>
