        ...
        <div className="grid md:grid-cols-2 gap-16">
          {[
            ...
            <motion.div
              ...
              className="p-10 rounded-2xl shadow-lg border-2 border-dark-teal"
              style={{
            ...
            >
              ...
              <p className="mt-2 text-light-orange">{person.role}</p>
              <p className="mt-6 text-black">{person.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
