  ...
  return (
    <main className="mx-auto max-w-7xl px-4 md:px-10 py-10">
      ...
      <header className="mb-8 md:mb-10">
        <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Create Community Story</h1>
        <p className="mt-2 text-slate-700">Build a multi-section blog post using card blocks.</p>
      </header>
