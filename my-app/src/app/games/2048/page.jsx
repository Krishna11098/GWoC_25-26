...
const TILE_COLORS = {
  ...
  128: {
    bg: "#edcf72",
    text: "#f9f6f2",
    textParams: { fontSize: "1.8rem", textShadow: "0 0 5px rgba(0,0,0,0.2)" },
  },
  256: {
    bg: "#edcc61",
    text: "#f9f6f2",
  ...
  1024: {
    bg: "#edc53f",
    text: "#f9f6f2",
    textParams: { fontSize: "1.5rem", textShadow: "0 0 5px rgba(0,0,0,0.2)" },
  },
  2048: {
    bg: "#edc22e",
    text: "#f9f6f2",
    textParams: { fontSize: "1.5rem", boxShadow: "0 0 10px #edc22e" },
  },
};
...
export default function Game2048() {
  ...
  return (
    <div className="min-h-screen text-[var(--dark-teal)] relative">
      <Navbar />
      <SoftWaveBackground height="420px" className="pointer-events-none" />
      <main className="pt-28 pb-10 px-4 md:px-8 flex flex-col items-center max-w-2xl mx-auto relative z-10">
        
        {/* Header */}
        <div className="w-full flex justify-between items-start mb-10 mt-10">
          <div>
            <motion.h1
          ...
          <div className="flex flex-col gap-2">
            <div
              className="p-3 rounded-lg text-center min-w-[80px] border-2"
              style={{
        ...
        <motion.div
          ...
          className="border-2 rounded-full px-6 py-2 mb-6 font-bold flex items-center gap-2"
          style={{
            backgroundColor: "var(--light-pink)",
            borderColor: "var(--dark-teal)",
            color: "var(--dark-teal)",
            boxShadow: "4px 4px 0px 0px var(--dark-teal)",
          }}
        >
        ...
        <div
          className="relative bg-white border-[3px] rounded-xl p-3 md:p-4"
          style={{
            borderColor: "var(--dark-teal)",
            boxShadow: "8px 8px 0px 0px var(--dark-teal)",
          }}
        >
          <div
            className="rounded-lg p-3 relative touch-none"
            ref={boardRef}
            ...
            <div className="grid grid-cols-4 gap-3">
              {Array(GRID_SIZE * GRID_SIZE)
                ...
                .map((_, i) => (
                  <div
                    key={i}
                    className="w-16 h-16 md:w-24 md:h-24 rounded-md ring-1"
                    style={{
            ...
            <AnimatePresence>
              {gameOver && (
                ...
                >
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded font-bold text-xl shadow-lg hover:scale-105 transition"
                    style={{
              ...
              {gameWon && !hasWon && (
                <motion.div
                  ...
                  animate={{ opacity: 1 }}
                  className="absolute inset-0 flex flex-col items-center justify-center rounded-lg z-10"
                  style={{ backgroundColor: "rgba(203, 216, 172, 0.95)" }}
                >
                  <h2
                    className="text-4xl font-bold mb-4"
                    style={{ color: "var(--dark-teal)" }}
                  ...
                  <div className="flex gap-4">
                    <button
                      ...
                      className="border-2 px-6 py-2 rounded font-bold shadow-lg transition"
                      style={{
                        backgroundColor: "var(--light-blue)",
                        borderColor: "var(--dark-teal)",
                        color: "var(--dark-teal)",
                    ...
                    <button
                      onClick={handleClaimReward}
                      className="px-6 py-2 rounded font-bold shadow-lg hover:scale-105 transition"
                      style={{
                        backgroundColor: "var(--green)",
                        color: "var(--dark-teal)",
                      }}
        ...
        <div className="mt-8 grid grid-cols-3 gap-2">
          <div />
          <button
            className="bg-white border-2 rounded-xl p-4 active:shadow-none active:translate-x-1 active:translate-y-1 transition-all"
            style={{
              borderColor: "var(--dark-teal)",
              color: "var(--dark-teal)",
              boxShadow: "4px 4px 0px 0px var(--dark-teal)",
          ...
          {showHowToPlay && (
            ...
            >
              ...
              >
                ...
                <h2 className="text-2xl font-bold mb-4 text-[var(--dark-teal)]">
                  How To Play
                </h2>
                <ul className="space-y-3 list-disc pl-5 text-[var(--font)]">
                  <li>
                    Use your <strong>arrow keys</strong> or the on-screen
                    buttons to move the tiles.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Earn Coins:</strong> When the game ends, claim coins
                    based on your score!
                  </li>
                </ul>
                <button
