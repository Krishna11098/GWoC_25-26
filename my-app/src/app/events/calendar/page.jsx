      ...
      <main className="mx-auto max-w-6xl xl:max-w-7xl px-4 md:px-10 py-10 mt-20">
        <div className="flex flex-col gap-10">
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-2 mb-6 text-slate-700">Browse dates and see events stored in the database.</p>
            {loadError && (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="rounded-3xl border shadow-lg bg-[#f6f7ed] p-5">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-lg font-bold text-[var(--color-foreground-2)]">Upcoming Events</h2>
                  ...
                  <div className="space-y-3">
                    {upcomingEvents.map((event, idx) => (
                      <div
                        ...
                        className="rounded-2xl border border-[var(--color-foreground)]/15 bg-white px-4 py-3 shadow-sm flex items-center justify-between gap-3 cursor-pointer hover:shadow-md hover:border-[var(--color-foreground)]/30 transition-all"
                      >
                        <div className="text-base font-bold text-slate-900 truncate">{event.title || "Untitled event"}</div>
